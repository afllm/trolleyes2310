...
public class ProductoDao {
    ...
    public ProductoBean create(ProductoBean oProductoBean) throws Exception {
        String strSQL = "INSERT INTO " + ob + " (`id`, `codigo`, `desc`, `existencias`,"
                + " `precio`, `foto`, `id_tipoProducto`) VALUES (NULL, ?,?,?,?,?,?); ";
        ResultSet oResultSet = null;
        PreparedStatement oPreparedStatement = null;
        try {
            oPreparedStatement = oConnection.prepareStatement(strSQL);
            ...
            oPreparedStatement.setInt(7, oProductoBean.getId_tipoProducto());
